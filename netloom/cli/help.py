...
def render_help(
    ...
    *,
    ...
    usage = (
        ...
        "  netloom policyelements network-device copy --from=dev --to=prod --dry-run\n"
        "\nCommon options:\n"
        ...
        "  '{<key>:{<operator>:<value>}}'.\n"
        "  --limit=N                          Page size for list (default:--all).\n"
        ...
        "  When '--filter=' is used, the following "
        " operators and syntax is available:"
