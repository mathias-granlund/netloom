...
SERVICE_PRIVILEGE_RULES: tuple[ServicePrivilegeRule, ...] = (
    ...
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="captive-portal-profile",
        privileges=("cppm_captive_portal_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="captive-portal-profile-name",
        privileges=("cppm_captive_portal_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="dur-class",
        privileges=("cppm_dur_class",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="dur-class-name",
        privileges=("cppm_dur_class",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="ethertype-access-control-list",
        privileges=("cppm_ethertype_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="ethertype-access-control-list-name",
        privileges=("cppm_ethertype_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="mac-access-control-list",
        privileges=("cppm_mac_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="mac-access-control-list-name",
        privileges=("cppm_mac_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="nat-pool",
        privileges=("cppm_nat_pool",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="nat-pool-name",
        privileges=("cppm_nat_pool",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="net-destination",
        privileges=("cppm_net_destination",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="net-destination-name",
        privileges=("cppm_net_destination",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="net-service",
        privileges=("cppm_net_service",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="net-service-name",
        privileges=("cppm_net_service",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="policer-profile",
        privileges=("cppm_policer_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="policer-profile-name",
        privileges=("cppm_policer_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="policy",
        privileges=("cppm_policy",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="policy-name",
    ...
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="qos-profile",
        privileges=("cppm_qos_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="qos-profile-name",
        privileges=("cppm_qos_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="session-access-control-list",
        privileges=("cppm_session_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="session-access-control-list-name",
        privileges=("cppm_session_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="stateless-access-control-list",
        privileges=("cppm_stateless_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="stateless-access-control-list-name",
        privileges=("cppm_stateless_access_control_list",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="time-range",
        privileges=("cppm_time_range",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="time-range-name",
        privileges=("cppm_time_range",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="voip-profile",
        privileges=("cppm_voip_profile",),
    ),
    ServicePrivilegeRule(
        module="enforcementprofile",
        service="voip-profile-name",
        privileges=("cppm_voip_profile",),
    ),
    ServicePrivilegeRule(
