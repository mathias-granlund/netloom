...
from netloom.core.catalog_runtime import (
    catalog_view_from_args,
    get_catalog_for_runtime,
)
...
def completion_needs_catalog(words: list[str]) -> bool:
    ...
    return module not in {"cache", "import", "load", "server", "shell", "show"}
...
def get_catalog_for_cli(
    ...
    *,
    ...
    return get_catalog_for_runtime(
        plugin,
        cp,
        token=token,
